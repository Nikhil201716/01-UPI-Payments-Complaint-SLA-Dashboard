...
> <https://nikhil201716.github.io/nikhil-data-portfolio/pages/project.html?id=01>
...
|---|---|---|
| 1 | `python scripts/generate_data.py` | Generating synthetic complaint data |
| 2 | `python scripts/clean_transform.py` | Cleaning & transforming raw data |
| 3 | `python scripts/build_database.py` | Building SQLite database |
| 4 | `python scripts/run_queries_check.py` | Validating SQL analysis queries |
| 5 | `python dashboard/build_excel_dashboard.py` | Building Excel dashboard |
...
Every stage prints the rows it wrote. The SLA breach rate and the complaint volumes it reports are the same numbers quoted on the portfolio site.
